    ...
    internal class SeedData
    {
        private static List<User> GetUsers()
        {
            var result = new Faker<User>("tr")
                ...
                .RuleFor(i => i.Password, i => PasswordEncryptor.Encryt(i.Internet.Password()))
        ...
        public async Task SeedAsync(IConfiguration configuration)
        {
            ...
            dbContextBuilder.UseSqlServer(configuration["UniSozlukDbConnectionString"]);

            var context=new UniSozlukContext(dbContextBuilder.Options);
